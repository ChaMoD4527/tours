                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card card-primary card-round">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title">Daily Payments</div>
                                        <div class="card-tools">
                                            <div class="dropdown">
                            ...
                            <div class="card card-round">
                                <div class="card-header">
                                    <div class="card-head-row card-tools-still-right">
                                        <h4 class="card-title">Travelers Geolocation</h4>
                                        <div class="card-tools">
                                    ...
                                    <p class="card-category">Map of the travel around the world</p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="card-list py-4">
                                        ...
                                        <div class="item-list">
                                            ...
                                            <div class="info-user ms-3">
                                                ...
                                                <div class="status">I recommend this</div>
                                            </div>
                                            <button class="btn btn-icon btn-link op-8 me-1">
                                                <i class="far fa-envelope"></i>
                                            </button>
                                        ...
                                        <div class="item-list">
                                            ...
                                            <div class="info-user ms-3">
                                                ...
                                                <div class="status">Highly Recommend</div>
                                            </div>
                                            <button class="btn btn-icon btn-link op-8 me-1">
                                                <i class="far fa-envelope"></i>
                                            </button>
                                        ...
                                        <div class="item-list">
                                            ...
                                            <div class="info-user ms-3">
                                                ...
                                                <div class="status">I love this</div>
                                            </div>
                                            <button class="btn btn-icon btn-link op-8 me-1">
                                                <i class="far fa-envelope"></i>
                                            </button>
                                        ...
                                        <div class="item-list">
                                            ...
                                            <div class="info-user ms-3">
                                                ...
                                                <div class="status">they service are best</div>
                                            </div>
                                            <button class="btn btn-icon btn-link op-8 me-1">
                                                <i class="far fa-envelope"></i>
                                            </button>
